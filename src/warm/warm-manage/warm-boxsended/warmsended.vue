	...
	export default {
          ...
          shortcuts: [{
            ...
            onClick(picker) {
              ...
              picker.$emit('pick', [start, end]);
                ...
                date:'',
                data:[],
                theight:window.innerWidth>=850?window.innerHeight-236:window.innerHeight-280,
                list_input:{
                    total:100,
                    pagesize:50,
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/alarm/boxsended',{params:{begintime:timecon[0],endtime:timecon[1],begincount:_bgincount,endcount:_endcount,appid:this.form.yjdj,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                    this.loading = false;
            ...
            cellclick(row, column, cell, event){
              ...
              // evt.graphic.attributes.rowinfo.RESULT="发送成功";
              // var v = new Object;
             ...
             exportData(){         
                ...
                if(typeof(this.form.yjdj)!='undefined' && this.form.yjdj!=null){
                  params+='&appid='+this.form.yjdj;
                }
                window.location.href='/'+this.$WarmTable+'/excel/exportsened?'+params;
            },
        },
    }
</script>