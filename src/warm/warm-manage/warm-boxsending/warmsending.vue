	...
	export default {
          ...
          shortcuts: [{
            ...
            onClick(picker) {
              ...
              picker.$emit('pick', [start, end]);
                ...
                date:'',
                data:[],
                theight:window.innerWidth>=980?window.innerHeight-236:window.innerHeight-280,
                list_input:{
                    total:100,
                    pagesize:50,
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/alarm/boxsending',{params:{begintime:timecon[0],endtime:timecon[1],begincount:_bgincount,endcount:_endcount,appid:this.form.dxlx,sign:this.form.fsjg,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                    this.loading = false;
            ...
            exportData(){  
                ...
                window.location.href='/'+this.$WarmTable+'/excel/exportsending?'+params;
            },
        },
    }
</script>