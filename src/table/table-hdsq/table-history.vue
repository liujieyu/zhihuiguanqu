  ...
  <div>
    <Content :style="{padding: '24px', background: '#fff'}">
      <Row :gutter="16">
        ...
        <Col>
           <Input search enter-button suffix="ios-search" placeholder="请输入站名" style="width: 180px;" @on-search="search" v-model="searchmsg" />
        </Col>
        <Col>
...
export default {
  ...
  methods: {
    ...
    Reload() {
      this.loading = true;
      this.axios.get("/guanqu/hedaoshuiqing/lishi_lishibiao?_page_size=" +this.list_input.pagesize +"&_page=" +this.list_input.current,{params:{Time_min:this.form.date[0].substr(0,19),STCD:this.searchs,STNM: this.CZMZ,Time_max:this.form.date[1].substr(0,19)}}).then(res => {
          console.log(res);
        ...
        this.axios.get("/guanqu/hedaoshuiqing/lishi_lishibiao?_page=1&_page_size=99999",{params:{Time_min:this.form.date[0].substr(0,19),STCD:this.searchs,STNM: this.CZMZ,Time_max:this.form.date[1].substr(0,19)}}).then(res => {
