    ...
    <div class="baseBoxContent">
        ...
        <div>
            ...
            >
                ...
                ></el-table-column>
                <el-table-column align="center" prop="spprwm" label="渗压水位(m)" sortable="custom" :width="115">
                    <template slot-scope="scope">
                        <div>
                            <span
                                :style="{
                            color: scope.row.pzjyz >= 0?'red' : 'black',
                            }"
                            >{{ scope.row.spprwm }}</span>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column align="center" prop="pzjyz" label="距阈值(m)" sortable="custom" :width="105">
                    <template slot-scope="scope">
                        {{ scope.row.pzjyz }}
                    </template>
                </el-table-column>
                <el-table-column align="center" prop="tm" label="水温(℃)" sortable="custom" :width="105">
                    <template slot-scope="scope">
                        {{ scope.row.tm }}
                    </template>
                </el-table-column>
        ...
        methods: {
            ...
            getTableDataFormParent() {
                ...
                this.featrue.Rows.map(val => {
                    ...
                    for(var i=0;i<rowinfo.slyllist.length;i++){
                        var rowobj=rowinfo.slyllist[i];
                        ...
                        dataobj.spprwm=rowobj.spprwm;
                        dataobj.tm=rowobj.tm;
                        dataobj.pzyz=rowobj.pzyz;
                        dataobj.pzjyz=rowobj.pzjyz;
