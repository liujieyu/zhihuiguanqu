    ...
    data(){
        ...
        methods:{
          Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/gatedd/xhxx',{params:{begincount:_bgincount,endcount:_endcount,sign:this.form.ddtype}}).then((res)=>{
                    this.loading = false;
          ...
          // 处理页码切换
            ...
            //导出
            exportExcel(){
              //this.axios.get('/'+this.$WarmTable+'/excel/exportgate', {params: {begincount:0,endcount:99999,sign:this.form.ddtype}});
              window.location.href='/'+this.$WarmTable+'/excel/exportgate?sign='+this.form.ddtype+'&begincount=0&endcount=99999';
            },
            //曲线图加载
            reloadchart(){
              this.axios.get('/'+this.$WarmTable+'/gatedd/xhchart', {params: {sign:this.form.ddtype}}).then(res => {
