...
<script type="text/javascript">
    ...
    export default {
        ...
        mounted(){
            var date = new Date();
            this.form.date = date.getFullYear().toString();
        ...
        methods:{
            ...
            STGRsearch(){
              ...
              if(this.form.gsdw === undefined){
                  this.form.gsdw = ''
              }else {
                  this.form.gsdw = this.form.gsdw
              }
              this.Reload();
            },
            LEVELsearch(){
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/shuikushuiqing/lishi_zuigaoshuiwei?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{YR:this.form.date,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,STGR:this.form.gsdw,LEVEL:this.form.skdj}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    ...
                    for (var i = 0;i<this.data.length ; i++) {
                          this.data[i].THZ = this.Z_Filter(this.data[i].THZ);
                          this.data[i].YHZQ = this.Z_Filter(this.data[i].YHZQ);
                    }
                });
