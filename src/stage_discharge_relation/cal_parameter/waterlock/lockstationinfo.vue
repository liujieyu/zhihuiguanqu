  ...
  export default 
  {
    ...
    methods:{
      Reload(){
        ...
        this.axios.get('/'+this.$WarmTable+'/ldparamter/gatelist',{params:{begincount:_bgincount,endcount:_endcount,sltp:this.form.sltp,stnm:this.form.searchmsg,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                    this.loading = false;
    ...
    exportData(){
      ...
      window.location.href='/'+this.$WarmTable+'/excel/exportlock?'+params;
    },
    },
  }
</script>