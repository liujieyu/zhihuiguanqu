...
export default {
  ...
  methods: {
    ...
    Reload() {
      console.log(localStorage.anniu);
      let obj = {
      ...
      this.loading = true;
      this.axios.get("/guanqu/qudaoshuiqing/lishi_lishibiao?_page_size="+this.list_input.pagesize +"&_page="+this.list_input.current+this.searchs,{params: obj}).then(res => {
          console.log(res);
          if (res.data.total != 0) {
      ...
      this.axios.get("/guanqu/qudaoshuiqing/lishi_lishibiao?_page_size=99999"+this.searchs,{params: obj}).then(res => {
