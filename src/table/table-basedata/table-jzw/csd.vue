        ...
        methods:{
            ...
            search(){
              if (this.form.searchmsg != '') {
                this.searchs = '&DediBasin_Name=like,'+this.form.searchmsg;
              }else{
                this.searchs = '';
              }
                this.Reload();
            ...
            Reload(){
                this.loading = true;
                this.axios.get('/guanqu/admin/WRP_IrrBTSediBasin?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
