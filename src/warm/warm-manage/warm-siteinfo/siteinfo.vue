	...
	export default {
          ...
          shortcuts: [{
            ...
            onClick(picker) {
              ...
              picker.$emit('pick', [start, end]);
                ...
                date:'',
                data:[],
                theight:window.innerWidth>=1340?window.innerHeight-236:window.innerHeight-280,
                list_input:{
                    total:100,
                    pagesize:50,
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/alarm/sitealarm',{params:{begintime:timecon[0],endtime:timecon[1],begincount:_bgincount,endcount:_endcount,adcd:this.form.xzqh,alarmlevel:this.form.yjdj,sitename:this.form.searchmsg,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                    this.loading = false;
            ...
            exportData(){
              if (this.form.model_adress.length == 0) {
                ...
                window.location.href='/'+this.$WarmTable+'/excel/exportsite?'+params;
            },
        },
    }
</script>