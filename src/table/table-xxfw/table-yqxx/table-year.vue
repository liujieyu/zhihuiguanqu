    ...
    export default {
        ...
        methods: {
            ...
            Reload() {
                ...
                this.axios.get('/guanqu/yuqing/lishi_niantongji?_page_size=' + this.list_input.pagesize + '&' + '_page=' + this.list_input.current + '&' + this.searchs, {params: obj}).then((res) => {
                    console.log(res);
                    this.loading = false;
                ...
                this.axios.get('/guanqu/yuqing/lishi_nianzhanshutongji?_page_size=99999' + this.searchs, {
                    params: {
                          TM: this.form.date,
                        //  Time_min:this.form.date[0],
                        //  Time_max:this.form.date[1],
                    ...
                    // this.six = res.data.list[0].rain6;
                 ...
                 this.axios.get('/guanqu/yuqing/lishi_nianliebiao?_page_size=99999' + this.searchs, {
                    params: {
                        TM: this.form.date,
                        YR: this.yqYear,
                        ADDVCD: this.form.xzqh,
