    ...
    <div>
        <Content :style="{padding: '24px', background: '#fff'}">
              <Row type="flex" style="margin: 10px;" :gutter="16" justify="start">
                ...
                <Col style="display: flex;justify-content: flex-start;align-items: center;">
                    站点类型:
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/qudaoshuiqing/lishi_yuebiao?'+this.searchs,{params:{YE:this.form.YE,MON:this.form.MON,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,STYPE:this.form.zdlx}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    // if(res.data.total == 0){
