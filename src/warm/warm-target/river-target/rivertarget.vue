...
<script type="text/javascript">
  ...
  export default 
  {
      ...
      Reload()
    {
      ...
      //调用后台函数，传递参数
      this.axios.get('/'+this.$WarmTable+'/alarm/getriveralarm',{params:{begincount:_bgincount,endcount:_endcount,stnm:this.form.searchmsg,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                    this.loading = false;
      ...
      exportToExcel() {
              ...
              window.location.href='/'+this.$WarmTable+'/excel/exportriveralarm?'+params;
      },
      sort_change(item){
        if(item.order==null){
            return;
