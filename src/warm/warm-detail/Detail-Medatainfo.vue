...
export default {
  ...
  methods: {
    ...
    var _endcount=_currentPage * _pageSizes; 
      ...
      // 获取详情数据
    this.axios.get(`/${this.$WarmTable}/strealmanage/filedetail`,{params:{meCode:this.info.ME_CODE,begincount:_bgincount,endcount:_endcount}})
      .then(res => {
    ...
    onSubmit(auditing){
        ...
        this.axios.get(`/${this.$WarmTable}/strealmanage/auditing`,{params:{meCode:this.info.ME_CODE,audiTm:this.form.audiTm,audiMan:this.form.audiMan,audinting:auditing}})
        .then(res => {
            if(res.data=="ok"){
                if(auditing==2){
