	...
	export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/strealmanage/getmefile',{params:{begintime:timecon[0],endtime:timecon[1],begincount:_bgincount,endcount:_endcount,audinting:this.form.shzt,meMan:this.form.searchmsg,orderBy:this.form.orderby,sequence:this.form.sequence}}).then((res)=>{
                   this.loading = false;
            ...
            exportData(){
                ...
                window.location.href='/'+this.$WarmTable+'/excel/exportmefile?'+params;
            },
            importData(){
